...
/**
 * Tracks which AbstractNautilusEntity instances are currently in an active dash.
 *
...
public class DashTracker {
    ...
    private static final WeakHashMap<AbstractNautilusEntity, Integer> PREV_COOLDOWN =
            new WeakHashMap<>();
    private static final WeakHashMap<AbstractNautilusEntity, Boolean> DASHING =
            new WeakHashMap<>();

    /** Called at the HEAD of AbstractNautilusEntity#dash(). */
    public static void markDashing(AbstractNautilusEntity entity) {
     ...
     * triggers the clear.
     */
    public static void tickEntity(AbstractNautilusEntity entity) {
    ...
    public static boolean isDashing(AbstractNautilusEntity entity) {
